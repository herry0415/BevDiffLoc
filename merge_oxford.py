...
if __name__ == '__main__':
    ...
    all_poses = []
    voxel_size = 0.4
    image_path = '/home/data/ldq/Oxford Radar Robotcar/merge_bev/' #! 用于存储
    pose_path = '/home/data/ldq/Oxford Radar Robotcar/merge_bev.txt'  #! 用于存储
    ...
    T1 = time.time()
    for i in tqdm(range(len(dataset)),desc='[merge_oxford] Processing'):
